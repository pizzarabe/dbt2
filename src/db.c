...
#ifdef NUODB
#include "nuodb_delivery.h"
#include "nuodb_integrity.h"
#include "nuodb_new_order.h"
#include "nuodb_order_status.h"
#include "nuodb_payment.h"
#include "nuodb_stock_level.h"
#endif /* NUODB */
...
#endif /* LIBMYSQL */
#ifdef NUODB
int db_init(char const * database, char const * username, char const * password, const char * timezone_name, const char * schema)
#endif /* NUODB */
#ifdef LIBDRIZZLE
...
#ifdef NUODB
    rc = _db_init(database, username, password, timezone_name, schema);
#endif /* NUODB */
